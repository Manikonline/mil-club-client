...
const ManageUser = () => {
    ...
    const { data: users = [], refetch } = useQuery(["users"], async () => {
        ...
        const res = await fetch(`https://mil-club-server.vercel.app/allusers`)
        return res.json();
    })
    console.log(users)

    const handleMakeAdmin = (user) => {
        fetch(`https://mil-club-server.vercel.app/users/admin/${user?._id}`, {
            method:"PATCH"
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleMakeInstructor =(user)=>{
        fetch(`https://mil-club-server.vercel.app/users/instructor/${user?._id}`, {
            method:"PATCH"
        })
            .then(res => res.json())
            .then(data => {
